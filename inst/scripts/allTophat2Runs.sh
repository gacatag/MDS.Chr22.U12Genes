#!/bin/bash
#
# Run this in your mapping folder. Read scripts/README.TXT in MDS.Chr22 package.
#indexPATH=/data1/ali/software/sequencing/bowtie2/indexes/hg19NoColor/hg19
#MAPPINGPATH=/data1/ali/analysis/zrsr2/mapping
#RAWDATAPATH=/data1/ali/projects/data/zrsr2
