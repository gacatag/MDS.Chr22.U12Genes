...
# Copy the u12Regions.bed file to MAPPINGPATH (i.e. your mapping path with SRR16916[33-48] subfolders) and run the following . 
# The folder used here is /data1/ali/analysis/zrsr2/mapping 
